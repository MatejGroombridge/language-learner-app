 ...
 * (key "triolingo-v1"). Kept as one JSON document in SharedPreferences so load is
...
class StateStore(context: Context) {
    private val prefs = context.getSharedPreferences("triolingo", Context.MODE_PRIVATE)
