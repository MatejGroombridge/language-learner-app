...
private fun triolingoScheme(p: TriolingoPalette, dark: Boolean): ColorScheme {
...
/**
 * Root theme. This app deliberately uses the Triolingo brand palette instead of
...
fun AppTheme(
    ...
    val palette = if (isDark) DarkTriolingo else LightTriolingo
    val colorScheme = triolingoScheme(palette, isDark)
    ...
    CompositionLocalProvider(LocalTriolingo provides palette) {
        MaterialTheme(
